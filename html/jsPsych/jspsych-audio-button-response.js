...
jsPsych.plugins["audio-button-response"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    if (trial.replay == true){
      html += '<button id="jspsych-audio-button-response-replay" class="jspsych-btn">'+'&nbsp'+'&nbsp'+'Replay'+'&nbsp'+'&nbsp'+'</button>';
    }
    ...
    var replay_time = 0;
    if (trial.replay == true) {
      display_element.querySelector('#jspsych-audio-button-response-replay').addEventListener('click', function () {
        if (context !== null) {
