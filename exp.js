    ...
    for (let n = 0; n < scount; n++) {//loop through the silders
        ...
        // For Odd counts (Transcription), we display survey-text.
            ...
            var text_response = {
                ...
                //require_movement: true,
                slider_width: 500,
                preamble: '<p>Please enter the transcription of the text you just heard</p>' + '<p>Remember: <br>- Please do NOT adjust your volume <br>- Please only use the Replay button if there was a distraction or loud noise that made it impossible to hear the audio clip.</p><p>Trial #: ' + j + ' of ' + length + '</p><br><br><textbox id = "transcription" required></textbox>',
                slider_name: snames[n],
                on_finish: function (data) {
                    data.window_resolution = window.innerWidth + ' x ' + window.innerHeight;
                }
            };
            timeline.push(document.getElementById("transcription").value);
        }
